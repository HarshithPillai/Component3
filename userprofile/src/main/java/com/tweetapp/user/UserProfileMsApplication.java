...
public class UserProfileMsApplication {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(UserProfileMsApplication.class);

	public static void main(String[] args) {
		SpringApplication.run(UserProfileMsApplication.class, args);
		LOGGER.info("UserProfileMsApplication started");
	}

	// for using swagger + actuator in 2.6.X
	@Bean
